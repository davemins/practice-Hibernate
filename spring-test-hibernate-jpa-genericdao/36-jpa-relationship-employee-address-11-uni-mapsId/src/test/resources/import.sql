...
-- ID: 1 ~ 2
insert into address(id, street, city) values (2, 'Hangang-daero', 'Seoul');
insert into address(id, street, city) values (1, 'Dongseo-daero', 'Daejon');
...
insert into phone (id, model, employee_id) values
    ...
    (currval('phone_seq')-50+3, 'iPhone', 2);
