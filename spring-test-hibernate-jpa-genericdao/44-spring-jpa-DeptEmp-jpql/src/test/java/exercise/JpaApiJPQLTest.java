...
public class JpaApiJPQLTest {
    ...
    void test_select_entity_from() {
        ...
        assertThat(employees).extracting("id").contains(1L,2L,3L,4L,5L,6L,7L,8L,9L,10L,11L);
    }
    ...
    void test_inner_join_implicit() {
        ...
        // Notice : 15L
        assertThat(employees).extracting("id").contains(1L,2L,3L,4L,5L,6L,7L,8L,9L,10L);
    }
