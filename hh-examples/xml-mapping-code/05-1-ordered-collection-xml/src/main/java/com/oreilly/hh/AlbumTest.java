    ...
    public static void main(String args[]) throws Exception {
        ...
        try {
            ...
            Album album = new Album("Counterfeit e.p.", 1,
                                    new ArrayList<Track>(5), new Date());
            session.persist(album);

            addAlbumTrack(album, "Compulsion",
                          "vol1/album83/track01.mp3", Time.valueOf("00:05:29"),
                          artist, 1, 1, session);
            ...
            addAlbumTrack(album, "Gone",
                          "vol1/album83/track04.mp3", Time.valueOf("00:03:32"),
                          artist, 1, 4, session);
            ...
            addAlbumTrack(album, "Motherless Child",
                          "vol1/album83/track06.mp3", Time.valueOf("00:03:32"),
                          artist, 1, 6, session);
